 ...
 * - Show extracted data in clean, editable cards/sections
...
const ParsedSummary = ({
  ...
  const hasUncertainItems = (items) => {
    return items?.some((item) => item.confidence && item.confidence < 0.8);
  };
 ...
 * Show skeleton while parsing is in progress
 */
